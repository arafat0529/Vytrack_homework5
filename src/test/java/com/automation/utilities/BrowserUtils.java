...
public class BrowserUtils {
    ...
    public static void waitForPageToLoad(long timeOutInSeconds) {
        ...
        try {
            WebDriverWait wait = new WebDriverWait(com.automation.utilities.Driver.getDriver(), timeOutInSeconds);
    ...
    public static void clickWithJS(WebElement element) {
        ((JavascriptExecutor) com.automation.utilities.Driver.getDriver()).executeScript("arguments[0].scrollIntoView(true);", element);
        ((JavascriptExecutor) com.automation.utilities.Driver.getDriver()).executeScript("arguments[0].click();", element);
    }
    ...
    public static String getScreenshot(String name) {
        ...
        TakesScreenshot takesScreenshot = (TakesScreenshot) com.automation.utilities.Driver.getDriver();
