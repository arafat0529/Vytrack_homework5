...
public class CalendarEventsPage extends AbstractPageBase {
    ...
    private WebElement allDayEventBox;
    ...
    public boolean isRepeatBoxSelected(){
        BrowserUtils.waitForPageToLoad(20);
    ...
    public void setStartTime(String time){
        ...
        startTime.clear();
        startTime.sendKeys(time, Keys.ENTER);
    }
    ...
    public void hoverOverThreeDots(){
        ...
        actions.moveToElement(threeDots).pause(2000).build().perform();
    }
